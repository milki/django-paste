...
urlpatterns = patterns(
    ...
    url(r'^your-latest/$', 'dpaste.views.snippet_userlist',
        name='snippet_userlist'),
    url(r'^your-settings/$', 'dpaste.views.userprefs',
        name='snippet_userprefs'),
    url(r'^(?P<snippet_id>[a-zA-Z0-9]{4})/$', 'dpaste.views.snippet_details',
